...
- (IBAction)share:(id)sender {
    [self.slidingViewController resetTopViewWithAnimations:nil onComplete:nil];
    NSString *text = [NSString stringWithFormat:@"Hey, check out this cool app called Dingo. It's great for buying and selling tickets - https://itunes.apple.com/gb/app/dingo/id893538091?mt=8." ];
